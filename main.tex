...
\section{Kapitel 5: Lineare Algebra – Vektorräume $\mathbb{R}^n$, $\mathbb{C}^n$ und Allgemeine Vektorräume}
    ...
    \begin{equation}
        \mathbb{R}^n =\underbrace{\mathbb{R} \times \mathbb{R} \times \mathbb{R} \times ... \mathbb{R} }_{n} = \left\{ \vec{x} = \left(\begin{array}{c}x_1 \\ x_2\\ ...\\ x_n \end{array}\right) : x_1, x_2, ..., x_n \in \mathbb{R}\right\}
    \end{equation}
    Dabei sind $\vec{x}$ geordnete n-Tupel von reellen Zahlen, als Spalte geschrieben sind. 
    \begin{equation}
        \mathbb{C}^n =\underbrace{\mathbb{C} \times \mathbb{C} \times \mathbb{C} \times ... \mathbb{C} }_{n} = \left\{ \vec{z} = \left(\begin{array}{c}z_1 \\ z_2\\ ...\\ z_n \end{array}\right) : z_1, z_2, ..., z_n \in \mathbb{R}\right\}
    \end{equation}
    ...
    \begin{equation}
        \mathbb{K}^n = \left\{ a = \left(\begin{array}{c}a_1 \\a_2 \\\dots \\a_n \end{array} \right): a_1, a_2, \dots, a_n \in \mathbb{K}\right\}
    \end{equation}
    ...
    nämlich
    \begin{equation}
        \vec{a} + \vec{b} = \left( \begin{array}{c}a_1 \\a_2 \\ \dots\\a_n \end{array}\right) + \left( \begin{array}{c}b_1 \\b_2 \\ \dots\\b_n \end{array}\right) = \left( \begin{array}{c}a_1 + b_1\\a_2 + b_2 \\ \dots\\a_n +b_n\end{array}\right), \hspace{1cm} \alpha \cdot \vec{a} = \alpha \cdot \left( \begin{array}{c}a_1 \\a_2 \\ \dots\\a_n \end{array}\right) = \left( \begin{array}{c}\alpha \cdot a_1 \\ \alpha \cdot a_2 \\ \dots\\ \alpha \cdot a_n \end{array}\right)
    \end{equation}

    Man überprüft leicht, dass für $V = \mathbb{K}^n$ die golgenden Eigenschaften dieser Operationen erfüllt sind:  
